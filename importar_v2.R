#01.02.2023
#05.02.2023 
#16.02.2023 new changes (nfc model is possible!)
...
# load data (when you have it complete)

load("background_L.rds")
load("healthL.rds")
load("personalityL.rds")
load("nbackgroundL.rds")
load("df_dv.rds") #results
load("df_person.rds") #results
...
nov7 <- import("../nfc/background /1. OTRAS/1. noviembre2007/noviembre2007.sav")
may8 <- import("../nfc/background /1. OTRAS/2. mayo2008/mayo2008.sav")
dic8 <- import("../nfc/background /0. ELEGIDAS/1. diciembre2008/diciembre2008.sav")
may9 <- import("../nfc/background /1. OTRAS/4. mayo2009/mayo2009.sav")
jun9 <- import("../nfc/background /0. ELEGIDAS/2. junio2009/junio2009.sav")
nov9 <- import("../nfc/background /2. FALTABA/noviembre_2009/noviembre2009.sav") 
dic9 <- import("../nfc/background /1. OTRAS/5. diciembre2009/diciembre2009.sav")
may10 <- import("../nfc/background /1. OTRAS/6. mayo2010/mayo2010.sav")
dic10 <- import("../nfc/background /1. OTRAS/7. diciembre2010/diciembre2010.sav")
may11 <- import("../nfc/background /1. OTRAS/8. mayo2011/mayo2011.sav")
dic11 <- import("../nfc/background /1. OTRAS/9. diciembre2011/diciembre2011.sav")
may12 <- import("../nfc/background /1. OTRAS/10. mayo2012/mayo2012.sav")
dic12 <- import("../nfc/background /0. ELEGIDAS/3. diciembre2012/diciembre2012.sav")
may13 <- import("../nfc/background /1. OTRAS/12. mayo2013/mayo2013.sav")
jun13 <- import("../nfc/background /0. ELEGIDAS/4. junio2013/junio2013.sav")
dic13 <- import("../nfc/background /1. OTRAS/13. diciembre2013/diciembre2013.sav")
may14 <- import("../nfc/background /1. OTRAS/14. mayo2014/mayo2014.sav")
dic14 <- import("../nfc/background /1. OTRAS/15. diciembre2014/diciembre2014.sav")
may15 <- import("../nfc/background /1. OTRAS/16. mayo2015/mayo2015.sav")
dic15 <- import("../nfc/background /1. OTRAS/17. diciembre2015/diciembre2015.sav")
may16 <- import("../nfc/background /1. OTRAS/18. mayo2016/mayo2016.sav")
dic16 <- import("../nfc/background /1. OTRAS/19. diciembre2016/diciembre2016.sav")
may17 <- import("../nfc/background /1. OTRAS/20. mayo2017/mayo2017.sav")
dic17 <- import("../nfc/background /0. ELEGIDAS/5. diciembre2017/diciembre2017.sav")
may18 <- import("../nfc/background /1. OTRAS/22. mayo2018/mayo2018.sav")
jun18 <- import("../nfc/background /0. ELEGIDAS/6. junio2018/junio2018.sav")
dic18 <- import("../nfc/background /1. OTRAS/23. diciembre2018/diciembre2018.sav")
nov19 <- import("../nfc/background /2. FALTABA/noviembre_2019/noviembre_2019.sav") 
nov20 <- import("../nfc/background /2. FALTABA/noviembre_2020/noviembre_2020.sav") 
dic20 <- import("../nfc/background /0. ELEGIDAS/7. diciembre2020/diciembre2020.sav")
dic21 <- import("../nfc/background /0. ELEGIDAS/8. diciembre2021/diciembre2021.sav")
...
h7 <- import("../nfc/health/ola 1 DESCARTADA/ch07a_2p_EN.sav")
h8 <- import("../nfc/health/ola 2 /BD.sav")
h9 <- import("../nfc/health/ola 3/ch09c_EN_1.1p.sav")
h10 <- import("../nfc/health/ola 4/ch10d_EN_1.0p.sav")
h11 <- import("../nfc/health/ola 5/ch11e_EN_1.0p.sav")
h12 <- import("../nfc/health/ola 6/ch12f_EN_1.0p.sav")
h13 <- import("../nfc/health/ola 7/ch13g_EN_1.0p.sav")
h15 <- import("../nfc/health/ola 8/ch15h_EN_1.2p.sav")
h16 <- import("../nfc/health/ola 9/ch16i_EN_1.0p.sav")
h17 <- import("../nfc/health/ola 10/ch17j_EN_1.0p.sav")
h18 <- import("../nfc/health/ola 11/ch18k_EN_1.0p.sav")
h19 <- import("../nfc/health/ola 12/ch19l_EN_1.0p.sav")
h20 <- import("../nfc/health/ola 13/ch20m_EN_1.0p.sav")
h21 <- import("../nfc/health/ola 14/ch21n_EN_1.0p.sav")
...
p8 <- import("bbdd/nfc/personality/ola 1/cp08a_1p_EN.sav")
p9 <- import("bbdd/nfc/personality/ola 2/cp09b_1.0p_EN.sav")
p10 <- import("bbdd/nfc/personality/ola 3/cp10c_1.0p_EN.sav")
p11 <- import("bbdd/nfc/personality/ola 4/cp11d_1.0p_EN.sav")
p12 <- import("bbdd/nfc/personality/ola 5/cp12e_1.0p_EN.sav")
p13 <- import("bbdd/nfc/personality/ola 6/cp13f_EN_1.0p.sav")
p14 <- import("bbdd/nfc/personality/ola 7/cp14g_EN_1.0p.sav")
p15 <- import("bbdd/nfc/personality/ola 8/cp15h_EN_1.0p.sav")
p17 <- import("bbdd/nfc/personality/ola 9/cp17i_EN_1.0p.sav")
p18 <- import("bbdd/nfc/personality/ola 10/cp18j_EN_1.0p.sav")
p19 <- import("bbdd/nfc/personality/ola 11/cp19k_EN_1.0p.sav") #NFC no available
p20 <- import("bbdd/nfc/personality/ola 12/cp20l_EN_1.0p.sav")
p21 <- import("bbdd/nfc/personality/ola 13/cp21m_EN_1.0p.sav")
p22 <- import("bbdd/nfc/personality/ola 14/cp22n_EN_1.0p.sav")
...
names(nfc)
nfc <- nfc[-which(is.na(nfc$NFC1)), -c(20:24)] # mismos sujetos con NA mhi1 son aquellos
